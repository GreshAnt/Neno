...
def main():
    while True:
        try:
            ...
            input_user = text()
            if (
                input_user == "Google Speech Recognition could not understand audio"
            ) or (
                'Could not request results from Google Speech Recognition service' in input_user
            ):
                continue
            ...
            convo.send_message(
                'Keep your replies short and sweet(INPORTANT):' + input_user
            )
